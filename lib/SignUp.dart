...
class SignUpState extends StatefulWidget{
  ...
  SignUpState(BuildContext context){
    this.context = context;
  }

  @override
  State createState() => _SignUpState(context);
...
class _SignUpState extends State<SignUpState>{
  ...
  password2Controller = TextEditingController(),phoneNumController = TextEditingController(),
      nameController = TextEditingController();

  BuildContext oldContext;

  _SignUpState(BuildContext context){
    oldContext = context;
  }
    ...
    return Padding(
      ...
      child:TextFormField(
        validator: (password){
          ...
          if(passwordController.value.text.compareTo(password2Controller.value.text) != 0){
